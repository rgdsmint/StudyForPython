...
# 生成随机的位置坐标
def get_random_pos():
    x, y = random.randint(20, 550), random.randint(20, 450)
    return x, y
...
def main():
    ...
    while running:
        ...
        button('好呀', like_pos_x, like_pos_y, like_pos_width, like_pos_height,
               like_color, screen)
        button('算了吧', unlike_pos_x, unlike_pos_y, unlike_pos_width,
               unlike_pos_height, (205, 173, 0), screen)
        pygame.display.flip()
        pygame.display.update()
        clock.tick(60)
    show_like_interface('我就知道小姐姐你也喜欢我~', screen, color=(240, 80, 80))
